...
// Calculate WPM with error adjustment
...
// Handle typing over the displayed text and scroling
document.addEventListener('keydown', (e) => {
    ...
    // Scroll the container only after 20 chracters
...
function showMobileMessage() {
    textContainer.textContent = 'This typing is designed for dekstop users only';
}
